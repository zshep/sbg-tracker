...
export default function StandardsCard({ standard, onDelete, onEdit }) {
  ...
  return (
    <div ref={setNodeRef} style={style} className={`standard-card ${isDragging ? "is-dragging" : ""}`}>
      ...
      <div className="standard-card__actions">
        <button type="button" className="btn" onClick={() => onEdit(standard)}>
          Edit
        </button>
